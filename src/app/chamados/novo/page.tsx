      ...
      <div style={{ padding: '2rem', maxWidth: 720, margin: '0 auto' }}>
        <div className="animate-fade-in-up" style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: 'rgba(240,238,255,0.45)', fontSize: '0.875rem' }}>
            Preencha as informaçÃµes abaixo para registrar sua solicitação
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div className="glass-card animate-fade-in-up animate-delay-100" style={{ padding: '1.5rem' }}>
            <label className="form-label" style={{ marginBottom: 12 }}>Ãrea de Atendimento *</label>
          ...
          <div className="glass-card animate-fade-in-up animate-delay-400" style={{ padding: '1.5rem' }}>
            ...
            <textarea
              ...
              placeholder="Descreva o problema com o máximo de detalhes possível. Quanto mais informaçÃµes, mais rápida será a resolução."
