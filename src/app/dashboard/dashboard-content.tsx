        ...
        {[
          {
            ...
            icon: <TicketIcon size={20} />, color: 'var(--Aca�-400)',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 24, alignItems: 'start' }}>
            ...
            <Link href="/chamados/novo" className="glass-card-hover" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{
                  ...
                  <Plus size={18} color="var(--Aca�-300)" />
                </div>
                <div>
        ...
        <div className="animate-fade-in-up animate-delay-300">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
            ...
            <Link href="/chamados" style={{ fontSize: '0.8rem', color: 'var(--Aca�-400)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>
                ...
                <tbody>
                  {recentTickets.map(ticket => (
                    <tr key={ticket.id} onClick={() => window.location.href = `/chamados/${ticket.id}`}>
                      <td>
                        <span style={{ fontFamily: 'monospace', fontSize: '0.78rem', color: 'var(--Aca�-300)' }}>
                          {ticket.protocol}
                        </span>
                      </td>
