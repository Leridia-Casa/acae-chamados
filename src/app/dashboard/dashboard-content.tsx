    ...
    <div style={{ padding: '2rem', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 24, alignItems: 'start' }}>
        ...
        <div className="animate-fade-in-up animate-delay-200">
          <h2 style={{ fontSize: '1rem', fontWeight: 700, color: '#f0eeff', marginBottom: 16 }}>AçÃµes rápidas</h2>
            ...
            <Link href="/chamados" className="glass-card-hover" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.75rem', color: 'rgba(240,238,255,0.4)' }}>Ver todas solicitaçÃµes</div>
                </div>
              </div>
              <ArrowRight size={16} color="rgba(240,238,255,0.3)" />
            </Link>
