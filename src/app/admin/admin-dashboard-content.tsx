  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <div className="animate-fade-in-up animate-delay-100" style={{
        ...
        {[
          { label: 'Total Chamados', value: stats.total, icon: <TicketIcon size={18} />, color: 'var(--acai-400)', bg: 'rgba(139,71,255,0.1)' },
          ...
          { label: 'Usuários', value: totalUsers, icon: <Users size={18} />, color: 'var(--acai-300)', bg: 'rgba(139,71,255,0.08)' },
        ].map((s, i) => (
      ...
      <div className="animate-fade-in-up animate-delay-200" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
        ...
        <div className="glass-card" style={{ padding: '1.5rem' }}>
          <h3 style={{ fontSize: '0.9rem', fontWeight: 700, color: '#f0eeff', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
            <TrendingUp size={16} color="var(--acai-400)" />
            Chamados por Área
          </h3>
            ...
            {[
              ...
              <Link key={link.href} href={link.href} className="glass-card-hover" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{ width: 34, height: 34, borderRadius: 9, background: 'rgba(139,71,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--acai-300)' }}>
                    {link.icon}
                  </div>
                  <div>
      ...
      <div className="animate-fade-in-up animate-delay-300">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          ...
          <Link href="/admin/chamados" style={{ fontSize: '0.8rem', color: 'var(--acai-400)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>
